                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 d-none d-lg-block">
                        <div class="sticky-top">
                            <div class="card mb-3 rounded-3">
                                <div class="card-body">
                                    <a href="https://bisabos.com" target="_blank" rel="noreferrer"><img src="assets/img/ads.png" alt="Bisabos - Media Pemrograman Indonesia" height="300" width="279" class="card-img-top" /></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <?php foreach($posts as $post){ ?>
                            <div class="card bg-light shadow bg-body rounded-3 mb-2">
                                <div class="card-body">
                                    <h2 class="card-title">
                                        <a href="<?php echo base_url('post/article/'.$post['post_id']); ?>"><?php echo $post['title'] ?></a>
                                    </h2>
                                    <p class="card-text"><?php echo substr($post['content'],0,120); ?>...</p>
